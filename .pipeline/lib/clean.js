  ...
  for (var k in phases){
    if (phases.hasOwnProperty(k)) {
      ...
      if (k == target_phase ){
        ...
        oc.raw('delete', ['pvc,Secret,configmap'], {selector:`app=${phase.instance},env-id=${phase.changeId},!shared,github-repo=${oc.git.repository},github-owner=${oc.git.owner}`, wait:'true', namespace:phase.namespace})
      }
    }
  }
}